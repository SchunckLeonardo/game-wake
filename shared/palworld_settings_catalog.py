...
FIELDS: tuple[SettingField, ...] = (
    ...
    SettingField(
        ...
        "Velocidade de produção no rancho",
        "Base and Palbox",
        "number",
        _POSITIVE_RATE,
        _RATE_MENU,
        "Multiplicador da velocidade de produção de itens por Pals no rancho.",
        minimum=0,
    ),
    SettingField(
    ...
    SettingField(
        "supply_drop_span",
        "SupplyDropSpan",
        "Meteorite and supply interval",
        "Intervalo de meteoritos e suprimentos",
        "Gameplay",
        "integer",
        ("número inteiro maior ou igual a 1, em minutos. A Pocketpair não publica valor máximo."),
        "Inteiro ≥ 1 minuto; a Pocketpair não publica máximo.",
        "Intervalo, em minutos, entre meteoritos e quedas de suprimentos.",
        minimum=1,
    ),
    SettingField(
        "pal_spawn_rate",
    ...
    SettingField(
        ...
        "Consumo de fome dos Pals",
        "Stamina and inventory",
        "number",
        _POSITIVE_RATE,
        _RATE_MENU,
        "Multiplicador do consumo de fome dos Pals.",
        minimum=0,
    ),
    SettingField(
